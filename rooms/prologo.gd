...
var text = {
	...
	Son guardias reales. Uno de ellos parece seguir con vida y te pide ayuda. Escoltaban al príncipe a través del bosque cuando encontraron una cueva. 
	
	El príncipe quiso explorar pero sus guardias se lo negaron. Y mientras hablaban, una criatura salió, los atacó y se llevó al príncipe. 
